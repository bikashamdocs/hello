...
export RESOURCE_GROUP_NAME="rg-ttsazure-lab-dev-techinsights-terraform"
export REPLICA_DB_SERVER_NAME="devdb-ti-fx-nreplica-2"
export DB_NAME= "ti_dev_db"
export REPLICA_DB_SERVER_NAME= "devdb-ti-fx-nreplica-2"
export DB_USER_NAME= "tistagingroot"
export DB_PASSWORD= "hVRve6*%tXi73!dNb#"
